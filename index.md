...
|Award Certificate|Korea Radioactive Waste Agency|2024.12|
...
|[Apparatus for providing tactile signals converted from image information and method thereof](https://doi.org/10.8080/1020130082120)|10-1428401-0000|
|[Method of image processing and device thereof](https://doi.org/10.8080/1020110108378)|10-1283262-0000|
|[Apparatus / method and computer readable medium having computer program for compact video](https://doi.org/10.8080/1020160087017)|10-1805018-0000|
|[AI-based material defect image generation method and defect detection system](https://doi.org/10.8080/1020200104317)|10-2263716-0000|
|[Multi sensor handover technology for parking service system](https://doi.org/10.8080/1020200164900)|10-2263715-0000|
|[Diffraction pattern classification system distinguished easily by computer and method of setting classification in the same](https://doi.org/10.8080/1020210156580)|10-2405557-0000|
|[AI-based material defect detection method and system](https://doi.org/10.8080/1020200107773)|10-2482507-0000|
|[System and method of converting imaginary tem sadp image to real tem sadp image or real tem sadp image to imaginary tem sadp image using deep learning](https://doi.org/10.8080/1020210171533)|10-2528617-0000|
|[Classification system with easy space group inference and method of recommending zone axis in the same](https://doi.org/10.8080/1020210185805)|10-2535327-0000|
|[Multi sensor handover system for tracking moving object and method of operating the same](https://doi.org/10.8080/1020200164899)|10-2546840-0000|
|[Handover system for tracking moving object and method of operating the same](https://doi.org/10.8080/1020200164898)|10-2581513-0000|
|[System and method of generating tem sadp image with high discernment](https://doi.org/10.8080/1020210170519)|10-2582498-0000|
|[Moving vehicle's number recognition and information guide system and method](https://doi.org/10.8080/1020200184220)|10-2593678-0000|
|[Method and system for providing parking service](https://doi.org/10.8080/1020210070232)|10-2699707-0000|
|[Classification system with easy space group inference and method of setting classification in the same](https://doi.org/10.8080/1020210156578)|10-2706530-0000|
|[Handover system for tracking moving object and method of operating the same](https://doi.org/10.8080/1020230123235)|10-2884988-0000|
|[How to provide parking system using qr code and make proxy payment](https://doi.org/10.8080/1020230051085)|10-2918552-0000|
|[System and method of converting imaginary tem sadp image to real tem sadp image or real tem sadp image to imaginary tem sadp image using deep learning](https://doi.org/10.8080/1020230015623)|10-2920875-0000|
|[System and method of generating tem sadp image with high discernment](https://doi.org/10.8080/1020230089980)|10-2931144-0000|
|[De-identification device for protecting private information and solving legal confilict and method of performing the same](https://doi.org/10.8080/1020240055525)|10-2947755-0000|

## Global registered patents
...
|Multi sensor handover system for tracking moving object and method of operating the same|JP7617672|
|Method and system for providing parking service|JP7694972|
|Method and system for providing parking service|US12603002|
|System and method of generating tem sadp image with high discernment|JP7760199|
|AI-based material defect detection system and method according to real defect image and defect detection system|JP7766374|
|Parking managing system for idendifying vehicle without congestion|JP7850478|
|Diffraction pattern classification system distinguished easily by computer and method of setting classification in the same|JP7729654|
|System and method of converting imaginary tem sadp image to real tem sadp image or real tem sadp image to imaginary tem sadp image using deep learning|JP7713757|